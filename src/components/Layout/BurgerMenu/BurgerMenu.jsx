          ...
          <nav className={s.menu} onClick={(e) => e.stopPropagation()}>
            ...
            <ul className={s.controls}>
              <li className={s.controlsItem}>
                <button onClick={cartHandler} className={s.controlsBtn}>
              ...
              <li className={s.controlsItem}>
                <button onClick={favHandler} className={s.controlsBtn}>
                  <div className={s.icon}>
            ...
            <ul className={s.categories}>
              ...
              <li className={s.categoryItem}>
                <NavLink
                  ...
                  onClick={closeHandler}
                  to={`/products/${routerIds.children}`}
                >
                  Childred
                </NavLink>
              </li>
              <li className={s.categoryItem}>
                <NavLink
                  ...
                  onClick={closeHandler}
                  to={`/products/${routerIds.accessories}`}
                >
                  Accessories
                </NavLink>
              </li>
